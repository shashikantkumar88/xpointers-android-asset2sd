 ...
 *
 * Copyright (c) Gautam Chaudhary 2014 http://www.gautamchaudhary.com
 */
...
public class Asset2SD extends CordovaPlugin {
     ...
     *
     * @param action The action to execute. (There is only a single action right
     * now)
    ...
    public String copyFile(String arg_assetFile, String arg_destinationFile) throws IOException {
        ...
        copyAssetFile(arg_assetFile, destination_full_file_path);
